...
export default function Home() {
  ...
  const lessons = [
    {
      title: "PM in 100 seconds (ish). What is a Product Manager and what do they do?",
      week: "Week 1",
    },
    { title: "Find the real problem (before you ship the wrong fix)", week: "Week 1" },
    { title: "Customer research that doesn't creep", week: "Week 1" },
    { title: "Jobs-to-be-done speed run", week: "Week 1" },
